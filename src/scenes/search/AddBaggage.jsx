...
const AddBaggage = ({
  ...
  }, [firstName, surName, middleName, gender, dateOfBirth, nationality, placeIssued, occupation, passportNumber]);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const updatedBaggageInfo = { ...baggageInfo, time: currentTime };
      ...
      const imageRef = ref(storage, `FaceImages/${updatedBaggageInfo.airportArrival}/${updatedBaggageInfo.airportArrival}wait/${docId}.png`);
  ...
  return (
    <>
      ...
      <DialogTitle>
          Add Baggage Declaration for {firstName} {middleName} {surName} (Passport: {passportNumber})
          <IconButton
            aria-label="close"
...
<FormControl fullWidth margin="dense">
          ...
          <Select name="airportArrival" value={baggageInfo.airportArrival} onChange={handleChange}>
        ...
        <DialogActions>
          ...
          <Button onClick={handleSubmit}>  {loading ? <CircularProgress size={24} /> : "Save"}
