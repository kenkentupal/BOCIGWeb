...
const airportList = [
    ...
    { code: 'BCD', name: 'Laoag International Airport (Ilocos Norte)' },
    { code: 'LAO', name: 'Silay International Airport (Bacolod)' },
    { code: 'SFS', name: 'Subic Bay International Airport (Zambales)' },
    { code: 'GES', name: 'General Santos International Airport (General Santos)' },
