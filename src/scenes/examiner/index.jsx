  ...
  const handleConfirmPassport = async () => {
    ...
    try {
      const docRef = doc(
        db,
        "BaggageInfo",
        baggageInfo.passportNumber + baggageInfo.dateOfArrival
      );
      ...
      (querySnapshot) => {
        ...
        if (selectedAirport) {
          const filtered = fetchedData.filter(
            (item) => item.airportArrival === selectedAirport
          );
  ...
  return (
    <Box m="20px">
      <Header
        ...
        subtitle="List of Arriving Passengers"
      />
      ...
      <BaggageInfoDialog
        ...
        onClose={() => setOpenBaggageDialog(false)}
      ...
      >
        <MenuItem onClick={handleConfirmPassport}>
          Confirm Passport (Manual)
        </MenuItem>
        <MenuItem onClick={handleConfirmFaceRecognition}>
          Confirm Face Recognition (Manual)
        </MenuItem>
        <MenuItem
          onClick={() => {
            if (baggageInfo) {
...
const DataGridContainer = ({ filteredData, colors, columns }) => (
  ...
  >
    <DataGrid
      ...
      sortModel={[{ field: "dateOfArrival", sort: "desc" }]} // Add this line to sort by date of arrival
    />
  </Box>
);
          ...
          <Box>
            ...
            <Grid container spacing={2} mb={2}>
              <Grid item xs={12} sm={6}>
                <Typography variant="body1">
                  <strong>Passport Number:</strong> {baggageInfo.passportNumber}
                </Typography>
              </Grid>
              <Grid item xs={12} sm={6}>
                <Typography variant="body1">
                  <strong>Name:</strong> {baggageInfo.firstName}{" "}
                  {baggageInfo.middleName} {baggageInfo.surName}
                </Typography>
              </Grid>
              <Grid item xs={12} sm={6}>
                <Typography variant="body1">
                  <strong>Nationality:</strong> {baggageInfo.nationality}
                </Typography>
              </Grid>
              <Grid item xs={12} sm={6}>
                <Typography variant="body1">
                  <strong>Date of Last Departure:</strong>{" "}
              ...
              <Grid item xs={12} sm={6}>
                <Typography variant="body1">
                  <strong>Date of Arrival:</strong> {baggageInfo.dateOfArrival}
                </Typography>
              </Grid>
              <Grid item xs={12} sm={6}>
                <Typography variant="body1">
                  <strong>Flight/Vessel:</strong> {baggageInfo.flightOrVessel}
                </Typography>
              </Grid>
              <Grid item xs={12} sm={6}>
                <Typography variant="body1">
                  <strong>Airport Arrival:</strong> {baggageInfo.airportArrival}
                </Typography>
              </Grid>
              <Grid item xs={12} sm={6}>
                <Typography variant="body1">
                  <strong>Traveler Type:</strong> {baggageInfo.travelerType}
                </Typography>
              </Grid>
              <Grid item xs={12} sm={6}>
                <Typography variant="body1">
            ...
            <Box my={2}>
              ...
              <Grid container spacing={2}>
                <Grid item xs={12} sm={6}>
                  <Typography variant="body1">
                    <strong>Goods Value:</strong> {baggageInfo.goodsValue}
                  </Typography>
                </Grid>
                <Grid item xs={12} sm={6}>
                  <Typography variant="body1">
                    <strong>Peso/Dollar Value:</strong>{" "}
                ...
                <Grid item xs={12} sm={6}>
                  <Typography variant="body1">
                    <strong>Hand Carried Baggage:</strong>{" "}
            ...
            <Box my={2}>
              ...
              <Grid container spacing={2}>
                <Grid item xs={12} sm={6}>
                  <Typography variant="body1">
                    <strong>Family Members Below 18:</strong>{" "}
                    {baggageInfo.familyMembers.below18}
                  </Typography>
                </Grid>
                <Grid item xs={12} sm={6}>
                  <Typography variant="body1">
                    <strong>Family Members Above 18:</strong>{" "}
            ...
            <Box my={2}>
              ...
              <Grid container spacing={2}>
                {baggageInfo.bringingItems &&
                  Object.keys(baggageInfo.bringingItems).map((item) => {
